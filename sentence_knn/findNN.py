...
if __name__ == "__main__":
    ...
    parser.add_argument("--all_sents", type=str, default='data/arapaho_raw.lower.txt')
    parser.add_argument("--all_sents_vectors", type=str, default='data/arapaho_sent2vec.lower.vec')
